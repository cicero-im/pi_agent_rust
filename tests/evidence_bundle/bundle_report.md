...
> Generated: 2026-09-07T13:22:06Z
> Git ref: 7c559e5c
> CI run: 34126260804
...
| Must-pass gate event log | PASS | 1 | 54708 B | `tests/ext_conformance/reports/gate/must_pass_events.jsonl` |
| Per-extension failure dossiers | MISS | 0 | 0 B | `tests/ext_conformance/reports/dossiers` |
| Health & regression delta report | PASS | 3 | 88379 B | `tests/ext_conformance/reports/health_delta` |
...
| PERF-3X stress triage report | PASS | 1 | 4573 B | `tests/perf/reports/stress_triage.json` |
...
- **PERF-3X lineage coherence contract** (invalid): PERF-3X lineage span exceeds 14 days for run_id '34126260804' (oldest=2026-05-02 00:53:26 UTC, newest=2026-09-07 13:22:05 UTC)
